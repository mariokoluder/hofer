      ...
      <div class="page-header">
        ...
        <div class="d-flex">
          <div class="justify-content-center">
            <a href="{{ route('manufacturers.create') }}" class="btn btn-primary my-2 btn-icon-text">
              <i class="fe fe-plus bg-white-transparent text-white"></i>
              <span>Novi dobavljač</span>
            </a>
          </div>
        </div>
      </div>
                  ...
                  <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('manufacturers.edit', $manufacturer) }}" class="btn ripple btn-outline-warning btn-sm" ><i class="fe fe-edit"></i> Uredi</a>
                          <button class="btn ripple btn-outline-danger btn-sm" data-bs-target="#modaldemo{{ $manufacturer->id }}" data-bs-toggle="modal"><i class="fe fe-trash"></i> Izbriši</button>
                          <div class="modal fade" id="modaldemo{{ $manufacturer->id }}">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content modal-content-demo">
                                <div class="modal-body">
                                  <p>Jeste li sigurni da želite izbrisati dobavljača <strong>{{ $manufacturer->title }}</strong>?</p>
                                </div>
                                <div class="modal-footer">
                                  <form action="{{ route('manufacturers.destroy', $manufacturer) }}" method="POST" style="display:inline-block;">@method('DELETE') @csrf <button type="submit" class="btn ripple btn-outline-danger"><i class="fe fe-trash"></i> DA</button>
